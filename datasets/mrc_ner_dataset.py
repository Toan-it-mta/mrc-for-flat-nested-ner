...
class MRCNERDataset(Dataset):
    ...
    def __getitem__(self, item):
        ...
        query_context_tokens = tokenizer.encode(query+'[UNKi]', context, add_special_tokens=True)
...
def run_dataset():
    ...
    # en datasets
    bert_path = "E:\\Code\\Python\\mrc-for-flat-nested-ner\\data\\models\\bert-base-uncased"
    # json_path = "/mnt/mrc/ace2004/mrc-ner.train"
    json_path = "E:\\Code\\Python\\mrc-for-flat-nested-ner\\data\\datasets\\conll03\\mrc-ner.test"
    is_chinese = False
